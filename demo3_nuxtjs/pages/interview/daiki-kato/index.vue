<template>
  <DefaultLayout :title="$t('interview02.name')" color="black" bg-color="whiteGradient">
    <!-- HERO IMAGE -->
    <section class="interview_heroSection">
      <img
        class="interview_heroSection_image"
        :src="require(`@/assets/images/creator/02/hero.webp`)"
        @load="onLoad"
      />
      <div class="interview_heroSection_heading" v-if="show">
        <TextMainVisual
          ...
          type="heroTitle"
          :title="$t('interview02.mainVisual.title1')"
          color="black"
        />
        <TextMainVisual
          :id="`heroSection-title2`"
          type="heroTitle"
          :title="$t('interview02.mainVisual.title2')"
          color="black"
        />
      </div>
    </section>
    ...
    <article class="interview_article">
      <section class="interview_introduction">
        <h1 class="interview_introduction_title">{{ $t('interview02.name') }}</h1>
        <div class="interview_introduction_subtitle">{{ $t('interview02.position') }}</div>
      </section>
      ...
      >
        <MediaTextBlock
          class="slide-in-item"
          :title="$t('interview02.qa[0].title')"
          :text="$t('interview02.qa[0].description')"
          :image-path="require('@/assets/images/creator/02/image_01.webp')"
          reverse
        />
      </section>
      ...
      >
        <MediaTextBlock
          class="slide-in-item"
          :title="$t('interview02.qa[1].title')"
          :text="$t('interview02.qa[1].description')"
          :image-path="require('@/assets/images/creator/02/image_02.webp')"
        />
      </section>
      ...
      >
        <div class="interview_mediaTextBlock_contents slide-in-item">
          <MediaTextBlock
            ...
            :text="$t('interview02.qa[1].description2')"
          />
        </div>
      </section>
      ...
      >
        <div class="interview_mediaTextBlock_contents slide-in-item">
          <MediaTextBlock
            class="slide-in-item"
            direction="horizontal"
            :text="$t('interview02.qa[1].description3')"
          />
        </div>
      </section>
      ...
      >
        <MediaTextBlock
          class="slide-in-item"
          :text="$t('interview02.qa[1].description4')"
          :image-path="require('@/assets/images/creator/02/image_03.webp')"
          reverse
        />
      </section>
      ...
      >
        <div class="interview_mediaTextBlock_contents slide-in-item">
          <MediaTextBlock
            class="slide-in-item"
            direction="horizontal"
            :text="$t('interview02.qa[1].description5')"
          />
        </div>
      </section>
      ...
      >
        <div class="interview_mediaTextBlock_contents slide-in-item">
          <MediaTextBlock
            class="slide-in-item"
            direction="horizontal"
            :text="$t('interview02.qa[1].description6')"
          />
        </div>
      </section>
      ...
      >
        <div class="interview_mediaTextBlock_contents slide-in-item">
          <MediaTextBlock
            class="slide-in-item"
            direction="horizontal"
            :text="$t('interview02.qa[1].description7')"
          />
        </div>
      </section>
      ...
      >
        <MediaTextBlock
          class="slide-in-item"
          reverse
          :text="$t('interview02.qa[1].description8')"
          :image-path="require('@/assets/images/creator/02/image_04.webp')"
        />
      </section>
      ...
      >
        <MediaTextBlock
          class="slide-in-item"
          :text="$t('interview02.qa[1].description9')"
          :image-path="require('@/assets/images/creator/02/image_05.webp')"
        />
      </section>
      ...
      >
        <MediaTextBlock class="slide-in-item" :text="$t('interview02.qa[1].description10')" />
      </section>
      ...
      >
        <MediaTextBlock
          class="slide-in-item"
          :title="$t('interview02.qa[2].title')"
          :text="$t('interview02.qa[2].description')"
          :image-path="require('@/assets/images/creator/02/image_06.webp')"
        />
      </section>
      ...
      >
        <MediaTextBlock class="slide-in-item" :text="$t('interview02.qa[2].description2')" />
      </section>
      ...
      >
        <MediaTextBlock class="slide-in-item" :text="$t('interview02.qa[2].description3')" />
      </section>
      ...
      >
        <MediaTextBlock class="slide-in-item" :text="$t('interview02.qa[2].description4')" />
      </section>
      ...
      >
        <div class="interview_mediaTextBlock_contents slide-in-item">
          <MediaTextBlock
            class="slide-in-item"
            :title="$t('interview02.qa[3].title')"
            :text="$t('interview02.qa[3].description')"
            :image-path="require('@/assets/images/creator/02/image_07.webp')"
            reverse
          />
        </div>
      </section>
      ...
      >
        <div class="interview_mediaTextBlock_contents slide-in-item">
          <MediaTextBlock class="slide-in-item" :text="$t('interview02.qa[3].description2')" />
        </div>
      </section>
      ...
      >
        <div class="interview_mediaTextBlock_contents slide-in-item">
          <MediaTextBlock
            class="slide-in-item"
            :text="$t('interview02.qa[3].description3')"
            reverse
          />
        </div>
      </section>
...
export default defineComponent({
  ...
  setup() {
    ...
    title.value = `${app.i18n.t('interview02.mainVisual.title1')}${app.i18n.t(
      'interview02.mainVisual.title2'
    )} | comony`
    meta.value = [
      {
        hid: 'description',
        name: 'description',
        content: app.i18n.t('interview02.qa[0].description')
      },
      {
        hid: 'og:title',
        property: 'og:title',
        content: `${app.i18n.t('interview02.mainVisual.title1')}${app.i18n.t(
    ...
    // 加藤 大樹氏 workspaceID='bnDdDp'
    const spaceList = ref([])
    const workspaceId = ref('bnDdDp')
...
.interview {
  ...
  &_heroSection {
    ...
    &_heading {
      ...
      @include screen(map-get($breakpoints, xs), map-get($breakpoints, lg)) {
        top: 20%;
        left: 0%;
        transform: scale(0.85, 0.85);
      }
