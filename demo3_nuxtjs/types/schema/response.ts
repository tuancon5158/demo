...
export interface I_User_Info_Response {
  email: string
  rolesId: number
  cognitoUid: string
  isActive: number
...
// user change email resonponse (get)
export interface I_User_Meta_Response {
  message: string
  $metadata: I_Meta
}
...
// get news
export interface I_Get_News_Response_Data {
  pagination: I_Pagination
  list: I_Get_News_Id_Response_Data[]
}
...
// Space Tickets
// ----------------------------------------------
export interface I_Get_SpaceTickets_CheckUser_Response_Data {
