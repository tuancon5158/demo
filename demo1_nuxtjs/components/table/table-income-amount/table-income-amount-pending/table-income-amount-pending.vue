...
import ButtonDetailsPending from '@/components/table/table-income-amount/table-income-amount-pending/button-details-pending.vue'
...
export default defineComponent({
  name: 'TableIncomeAmountPending',
  components: {
    ButtonDetailsPending,
    ButtonAcceptAll,
    ButtonDeclineAll,
    SectionStatus,
  },
