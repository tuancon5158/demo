<template>
  <div>
    ...
    <a-modal v-model="visible" centered title="Chi tiết đơn đăng ký làm thêm">
      <a-descriptions :column="1" bordered>
        ...
        <a-descriptions-item label="Hình ảnh">
          <t-img v-if="item.images.length" :src="item.images[0]"></t-img>
        </a-descriptions-item>
      </a-descriptions>
...
export default defineComponent({
  ...
  props: {
    item: {
      type: Object as PropType<IOvertime>,
      default: () => ({}),
    },
  },
  ...
  setup(props, { emit }) {
    ...
    const { approve, reject } = useServiceOvertime()
